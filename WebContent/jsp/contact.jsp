...
<h1 style="margin-top:80px;text-align:center;"><fmt:message key="contact"/></h1>
<div style="margin-bottom:60%;">
<fmt:message key="my_profile.email"/> : gmaksim2012@gmail.com<br>
<fmt:message key="my_profile.phone_number"/> : 80292223483<br>
Skype : gmaxim2111<br>
</div>
