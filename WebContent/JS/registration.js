...
var usernameValidityChecks = [
	{
		...
		element: document.querySelector('label[for="nickname"] .checker li:nth-child(1)')
	},
	{
		isInvalid: function(input) {
		...
		element: document.querySelector('label[for="nickname"] .checker li:nth-child(2)')
	}
];
...
{
	isInvalid: function(input) {
		return !input.value.match(/^[a-z0-9_-]+@[a-z0-9-]+\.([a-z]{1,6}\.)?[a-z]{2,6}/g);
	},
	invalidityMessage: 'Incorrect E-mail',
	element: document.querySelector('label[for="email"] .checker li:nth-child(1)')
}
];
